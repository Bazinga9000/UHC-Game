...
/**
 * Didn't feel like dealing with Bukkit's bullshit
 */
public final class Ench {
    ...
    public static final Enchantment CURSE_OF_BINDING      = Enchantment.BINDING_CURSE;
    ...
    public static final Enchantment LUCK                  = Enchantment.LUCK;
    public static final Enchantment LURE                  = Enchantment.LURE;
    public static final Enchantment MENDING               = Enchantment.MENDING;
    public static final Enchantment MULTISHOT             = Enchantment.MULTISHOT;
    public static final Enchantment RESPIRATION           = Enchantment.OXYGEN;
    public static final Enchantment PIERCING              = Enchantment.PIERCING;
    ...
    public static final Enchantment SOUL_SPEED            = Enchantment.SOUL_SPEED;
    ...
    public static final Enchantment CURSE_OF_VANISHING    = Enchantment.VANISHING_CURSE;
