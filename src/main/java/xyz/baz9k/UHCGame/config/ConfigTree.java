...
public class ConfigTree {
    ...
    private BranchNode generateTree() {
        ...
        new ValuedNode(wbSize, slotAt(1, 3), new NodeItemStack(Material.ORANGE_STAINED_GLASS, "First Movement", "Diameter: %s"),          ValuedNode.Type.DOUBLE, "wbsize.border1");
        new ValuedNode(wbSize, slotAt(1, 5), new NodeItemStack(Material.GREEN_STAINED_GLASS,  "Second Movement", "Diameter: %s"),         ValuedNode.Type.DOUBLE, "wbsize.border2");
        new ValuedNode(wbSize, slotAt(1, 6), new NodeItemStack(Material.PURPLE_STAINED_GLASS, "Deathmatch World Border", "Diameter: %s"), ValuedNode.Type.DOUBLE, "wbsize.deathmatch");
